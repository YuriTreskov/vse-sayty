...
<section  className={css.container} style={{overflow:'hidden'}}>
    <img   className={css.paralax} style={{zIndex:'1',opacity:'1'}} src="Page1/sl0.webp" alt="" />
    <motion.img  initial={{ opacity:0 }} viewport={{once:true}}  whileInView={{ opacity:1 }} transition={{delay:4}} className={css.paralax} ref={sl1}   src="Page1/sl1.png" alt="" />
    <motion.img initial={{ opacity:0 }} viewport={{once:true}}  whileInView={{ opacity:1 }} transition={{delay:3}}  className={css.paralax} ref={sl2}   src="Page1/sl2.png" alt="" />
    <motion.img  initial={{ opacity:0 }} viewport={{once:true}}  whileInView={{ opacity:1 }} transition={{delay:2}} className={css.paralax} ref={sl3}   src="Page1/sl3.png" alt="" />
    <motion.img  initial={{ opacity:0 }} viewport={{once:true}}  whileInView={{ opacity:1 }} transition={{delay:2}} className={css.paralax} ref={sl4}  src="Page1/sl4.png" alt="" />
    <motion.img  initial={{ opacity:0 }} viewport={{once:true}}  whileInView={{ opacity:1 }} transition={{delay:4}} className={css.paralax} ref={sl5}  src="Page1/sl5.png" alt="" />
    <motion.img  initial={{ opacity:0 }} viewport={{once:true}}  whileInView={{ opacity:1 }} transition={{delay:3}} className={css.paralax} ref={sl6}  src="Page1/sl6.png" alt="" />
